...
/**
 * Board avançado de objetivos (estilo Monday) — a experiência COMPLETA de
 * poder: árvore/mapa/kanban, filtros completos, criação, auditoria e itens
 * excluídos. Extraída da antiga página `Objectives` para virar a terceira aba
 * ("Board (avançado)") do redesign de /objectives, preservando o comportamento
 * 1:1. Não inclui o `AppLayout` — a página tabbed o fornece.
 */

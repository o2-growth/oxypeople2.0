/**
 * ESPELHO de `src/lib/kr-progress.ts` — não edite só este arquivo.
 *
 * O MCP responde "o CAC está dentro da meta?" e precisa da MESMA conta que a
 * tela usa. Sem isto, o servidor responderia 89% para um CAC de R$ 10.704 num
 * teto de R$ 12.000 — o erro que o dashboard tinha até 08/09.
 *
 * `src/lib/kr-progress.mirror.test.ts` compara os dois arquivos.
 */
